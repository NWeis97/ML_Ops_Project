...
#Save model
torch.save(model, 'models/fits/' + args.modelType + '_lr' + str(args.lr) + '_e' + str(args.epochs)+ '_bs' +str(args.batchsize) + '.pth')

#Plot training loss
sns.set_theme()
plt.plot(train_losses);
plt.savefig('reports/figures/training_loss/'+ args.modelType + '_lr' + str(args.lr) + '_e' + str(args.epochs)+ '_bs' +str(args.batchsize) + '.png')